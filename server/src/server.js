...
const { typesRouter, allocationsRouter, requestsRouter } = require('./modules/timeoff/timeoff.routes');
...
app.use(['/api/v1/time-off-types', '/api/time-off-types'], typesRouter);
app.use(['/api/v1/time-off-allocations', '/api/time-off-allocations'], allocationsRouter);
app.use(['/api/v1/time-off-requests', '/api/time-off-requests'], requestsRouter);
